...
public class FormValidatorOld { // FIXME replace
	private final FormElementTypeOld type;
	private final String message;
	private final ValidatorOptions options;

	public static enum FormElementTypeOld {
		INPUT_TEXT, INPUT_CHECKBOX, INPUT_PASSWORD, SELECT, BUTTON, BUTTON_ICON
	}
	...
	public static FormValidatorOld of(FormElementTypeOld type, ValidatorOptions options, String message) {
		return new FormValidatorOld(type, options, message);
	}

	public FormValidatorOld(FormElementTypeOld type, ValidatorOptions options, String message) {
		this.type = type;
	...
	public FormValidatorOld(FormElementTypeOld type, String name, String message, ValidatorOptions options) {
		this.type = type;
		this.message = message;
		this.options = options;
	}
